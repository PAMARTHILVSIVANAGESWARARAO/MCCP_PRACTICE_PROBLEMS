...
public class PrintNonLeafNodesWithOnlyLeftSubTree {
    static class Node {
        int data;
        Node left, right;
        Node (int data) {
    ...
    // Static input array
    static int[] inputArray = {50, 30, 70, 20, 40, 60, 80 , 10 , 5 , 15 , 2 , 8 , 9};
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n--- Interior/Non-leaf Nodes - Nodes with only left subtree ---");
